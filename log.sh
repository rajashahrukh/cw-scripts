...
cp -r /home/master/applications/$1/logs/apache*.cloudwaysapps.com.access.log.1 /var/cw/systeam/logs/apache-$1.access.log
...
cp -r /home/master/applications/$1/logs/nginx*.cloudwaysapps.com.access.log.1 /var/cw/systeam/logs/nginx-$1.access.log

#Recent 100 lines of PHP Slow logs
cp -r /home/master/applications/$1/logs/php-app.slow.log.1 /var/cw/systeam/logs/php-app.slow.log
...
#PHPFPM logs
cp -r /var/log/php$(php -v | head -n 1 | cut -d " " -f2 | cut -d "." -f1,2)-fpm.log.1 /var/cw/systeam/logs/php$(php -v | head -n 1 | cut -d " " -f2 | cut -d "." -f1,2)-fpm.log
